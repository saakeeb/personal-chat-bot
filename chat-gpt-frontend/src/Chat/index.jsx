...
const handledata = async () => {
  if (input.trim) {
    ...
    console.log(resdata, "Response recevied");
          ...
          <div className="h-[80%] border flex flex-col justify-center items-center text-black">
            ...
            <div className="flex flex-wrap justify-around max-w-[900px]">
              {example.map((item, index) => {
                return (
                  <div  className="text-lg font-light p-4 border border-black rounded min-w-[400px] mt-4 hover:bg-slate-300" onClick={() => {setInput(item)}}>
                    {item} 
                  </div>
                );
              })}
          ...
          <div className="flex flex-col items-center justify-center h-full  w-full">
            <div className="w-[75%] flex justify-center relative">
              <input
                ...
                placeholder="Type Best prompt" value={input}
